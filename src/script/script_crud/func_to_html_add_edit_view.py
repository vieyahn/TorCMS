...
def gen_input_add(sig):
    ...
    <input id='{0}' name="{0}" value="" type="text"  class="input_text"> {2} </label>
...
def gen_input_edit(sig):
    ...
    <input id='{0}' name="{0}" value="{{{{ post_info.extinfo['{0}'] }}}}" type="text"  class="input_text"> {2} </label>
    '''.format(sig['en'], sig['zh'], sig['dic'][1])
    return (edit_fangjia)
...
def gen_input_view(sig):
    ...
    <div class="col-sm-8"><span class="val">{{{{ post_info.extinfo['{0}'] }}}} {2}</span></div>
    '''.format(sig['en'], sig['zh'], sig['dic'][1])
    return (out_str)
